...
namespace MyNamespace
{
    ...
    {
        private System.Collections.ObjectModel.ObservableCollection<int> _networkData = new System.Collections.ObjectModel.ObservableCollection<int>();
    
        /// <summary>One block of the coordinator network info data.</summary>
        [Newtonsoft.Json.JsonProperty("networkData", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<int> NetworkData
        {
