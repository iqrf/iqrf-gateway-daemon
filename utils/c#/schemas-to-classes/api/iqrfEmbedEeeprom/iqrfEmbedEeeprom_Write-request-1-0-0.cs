...
namespace iqrfEmbedEeeprom_Write_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedEeeprom_Write_Request 
    {
        /// <summary>Embedded peripheral Memory - Write request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedEeeprom_Write_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedEeeprom_Write_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedEeeprom_Write_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedEeeprom_Write_RequestMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedEeeprom_Write")]
    
        IqrfEmbedEeeprom_Write = 0,
    ...
    public partial class Param 
    {
        ...
        /// <summary>Data to be written.</summary>
        [Newtonsoft.Json.JsonProperty("pData", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<int> PData { get; set; }
