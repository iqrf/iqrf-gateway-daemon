...
namespace iqrfEmbedOs_WriteCfg_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedOs_WriteCfg_Response 
    {
        /// <summary>Embedded peripheral OS - Write Configuration response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedOs_WriteCfg_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedOs_WriteCfg_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedOs_WriteCfg_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedOs_WriteCfg_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedOs_WriteCfg")]
    
        IqrfEmbedOs_WriteCfg = 0,
