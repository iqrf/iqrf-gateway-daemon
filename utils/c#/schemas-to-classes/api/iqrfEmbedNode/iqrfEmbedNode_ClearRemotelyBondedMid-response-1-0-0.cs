...
namespace iqrfEmbedNode_ClearRemotelyBondedMid_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedNode_ClearRemotelyBondedMid_Response 
    {
        /// <summary>Embedded peripheral Node - Clear Remotely Bonded Module ID response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedNode_ClearRemotelyBondedMid_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedNode_ClearRemotelyBondedMid_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedNode_ClearRemotelyBondedMid_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedNode_ClearRemotelyBondedMid_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedNode_ClearRemotelyBondedMid")]
    
        IqrfEmbedNode_ClearRemotelyBondedMid = 0,
