...
namespace iqrfBinaryoutput_SetOutput_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfBinaryoutput_SetOutput_Response 
    {
        ...
        public IqrfBinaryoutput_SetOutput_ResponseMType MType { get; set; }
        ...
        public static IqrfBinaryoutput_SetOutput_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfBinaryoutput_SetOutput_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfBinaryoutput_SetOutput_ResponseMType
    {
    ...
    {
        /// <summary>Array of boolean true/false values specifying the previous state of each binary output. false is returned for unimplemented binary outputs.</summary>
        ...
        public System.Collections.ObjectModel.ObservableCollection<bool> PrevVals { get; set; }
