...
#docker build -f arm64-latest.Dockerfile -t iqrftech/iqrf-gateway-daemon:latest-arm64 .
...
docker build -f iqube-latest.Dockerfile -t iqrftech/iqrf-gateway-daemon:latest-iqube .
