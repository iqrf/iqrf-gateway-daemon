...
pushd %builddir%
cmake -G "Visual Studio 15 2017 Win64" -DBUILD_TESTING:BOOL=true -DCMAKE_TOOLCHAIN_FILE=%vcpkg% -DVCPKG_VER=%vcpkg_ver% -Dshape_DIR:PATH=%shape% -Dshapeware_DIR:PATH=%shaparts% %currentdir%
popd
