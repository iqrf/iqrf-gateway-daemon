...
pushd %builddir%
cmake -G "Visual Studio 17 2022" -DBUILD_TESTING:BOOL=false -DCMAKE_TOOLCHAIN_FILE=%vcpkg% -DVCPKG_VER=%vcpkg_ver% -Dshape_DIR:PATH=%shape% -Dshapeware_DIR:PATH=%shaparts% -DDAEMON_VERSION:STRING=%ver% %currentdir%
popd
