...
namespace mngScheduler_AddTask_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class MngScheduler_AddTask_Request 
    {
        ...
        public MngScheduler_AddTask_RequestMType MType { get; set; }
        ...
        public static MngScheduler_AddTask_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<MngScheduler_AddTask_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum MngScheduler_AddTask_RequestMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "mngScheduler_AddTask")]
    
        MngScheduler_AddTask = 0,
