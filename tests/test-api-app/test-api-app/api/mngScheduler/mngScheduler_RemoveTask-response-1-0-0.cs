...
namespace mngScheduler_RemoveTask_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class MngScheduler_RemoveTask_Response 
    {
        ...
        public MngScheduler_RemoveTask_ResponseMType MType { get; set; }
        ...
        public static MngScheduler_RemoveTask_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<MngScheduler_RemoveTask_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum MngScheduler_RemoveTask_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "mngScheduler_RemoveTask")]
    
        MngScheduler_RemoveTask = 0,
