...
TEST_F(DatetimeParserTest, valid_utc) {
  auto tp = DatetimeParser::parseISO8601("2025-12-14T01:25:40Z");
  std::tm tm = get_tm(tp);
...
TEST_F(DatetimeParserTest, positive_offset) {
  auto tp = DatetimeParser::parseISO8601("2025-12-14T12:00:00+02:00");
  // SHOULD BE 10 AM UTC
  std::tm tm = get_tm(tp);
...
TEST_F(DatetimeParserTest, positive_offset_last_day) {
  auto tp = DatetimeParser::parseISO8601("2025-12-14T02:00:00+05:00");
...
TEST_F(DatetimeParserTest, negative_offset) {
  auto tp = DatetimeParser::parseISO8601("2025-12-14T12:00:00-05:00");
  // SHOULD BE 17 PM UTC
  std::tm tm = get_tm(tp);
...
TEST_F(DatetimeParserTest, negative_offset_next_day) {
  auto tp = DatetimeParser::parseISO8601("2025-12-14T23:00:00-05:00");
...
TEST_F(DatetimeParserTest, valid_millis) {
  auto tp = DatetimeParser::parseISO8601("2025-12-14T12:00:00.789Z");
  std::tm tm = get_tm(tp);
...
TEST_F(DatetimeParserTest, valid_leap_year) {
  auto tp = DatetimeParser::parseISO8601("2024-02-29T00:00:00Z");
  std::tm tm = get_tm(tp);
...
TEST_F(DatetimeParserTest, non_leap_year_feb) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-02-29T00:00:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, invalid_month) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-13-29T00:00:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, invalid_day_30_month) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-31T00:00:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, invalid_day_31_month) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-01-32T00:00:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, invalid_hour) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30T30:00:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, invalid_hour_edge) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30T24:00:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, invalid_minute) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30T10:78:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, invalid_minute_edge) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30T10:60:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, invalid_second) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30T23:00:61Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, missing_time) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, missing_time_T) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30T"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, missing_time_with_zone) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, missing_date_T) {
  EXPECT_THROW(DatetimeParser::parseISO8601("T23:00:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, missing_date) {
  EXPECT_THROW(DatetimeParser::parseISO8601("23:00:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, missing_time_zone) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30T23:00:00"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, missing_seconds) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30T23:00Z"), std::invalid_argument);
}

TEST_F(DatetimeParserTest, lowercase_zone) {
  EXPECT_THROW(DatetimeParser::parseISO8601("2021-04-30T23:00:00z"), std::invalid_argument);
}
