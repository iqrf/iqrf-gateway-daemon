 ...
 * @param `boost::beast::error_code` error code
 */
using WsServerOnOpen = std::function<void(std::size_t, boost::beast::error_code)>;
 ...
 * @param `boost::beast::error_code` error code
 */
using WsServerOnClose = std::function<void(std::size_t, boost::beast::error_code)>;
