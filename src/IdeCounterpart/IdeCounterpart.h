...
namespace iqrf {
  ...
  public:
     ...
     */
    void registerModeChangeCallback(const std::string &instanceId, std::function<void()> callback) override;
     ...
     */
    void unregisterModeChangeCallback(const std::string &instanceId) override;
     ...
     */
    void processClientDisconnected(const MessagingInstance& messaging) override;
     ...
     */
    void attachInterface(iqrf::IAuthService* iface);

    /**
     * Detaches authentication service interface
     * @param iface Authentication service interface
     */
    void detachInterface(iqrf::IAuthService* iface);
  ...
  private:
     ...
     */
    void executeModeChangeCallbacks();
