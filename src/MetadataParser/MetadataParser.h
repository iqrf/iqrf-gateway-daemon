...
namespace iqrf::metadata {
  ...
  /**
   * Metadata profile parser
   */
  class MetadataParser : public BaseParser {
   public:
    /**
     * Parse `nlohmann::json` document containing metadata profile
     * and return `Metadata` object.
     *
     * This method parses only properties present in version 0.
     *
     * @param doc `nlohmann::json` document
     * @return `Metadata` Parsed metadata profile
     */
    static Metadata parseV0(const nlohmann::json& doc);
     ...
     * @return `Metadata` Parsed metadata profile
     */
    static Metadata parseV1(const nlohmann::json& doc);
   private:
    /**
     ...
     *
     * The required properties are: hwpidVersions, routing, beaming, repeater, frcAggregation,
     *   iqarosCompatible, iqrfSensor, iqrfBinaryOutput, powerSupply
     *
     * @param doc `nlohmann::json` document
