...
namespace iqrf {
	...
	/**
	 * Daemon set mode request message
	 */
	class MngSetModeMsg : public MngBaseMsg {
	public:
		/// Delete base constructor
		MngSetModeMsg() = delete;
		 ...
		 */
		MngSetModeMsg(const Document &doc, IUdpConnectorService *udpConnectorService);

		/**
		 * Destructor
		 */
		virtual ~MngSetModeMsg() {};
