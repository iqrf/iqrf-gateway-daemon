...
namespace iqrfEmbedExplore_PeripheralInformation_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedExplore_PeripheralInformation_Response 
    {
        /// <summary>Embedded peripheral Explore - Peripheral Information response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedExplore_PeripheralInformation_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedExplore_PeripheralInformation_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedExplore_PeripheralInformation_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedExplore_PeripheralInformation_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedExplore_PeripheralInformation")]
    
        IqrfEmbedExplore_PeripheralInformation = 0,
    ...
    public partial class Result 
    {
        ...
        [Newtonsoft.Json.JsonProperty("perTe", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("perT", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
