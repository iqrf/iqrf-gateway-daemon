...
namespace iqrfEmbedCoordinator_SetDpaParams_Request
{
    ...
    public partial class IqrfEmbedCoordinator_SetDpaParams_Request 
    {
        ...
        public IqrfEmbedCoordinator_SetDpaParams_RequestMType MType { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedCoordinator_SetDpaParams_RequestMType
    {
    ...
    public partial class Param 
    {
        ...
        [Newtonsoft.Json.JsonProperty("dpaParam", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? DpaParam { get; set; }
