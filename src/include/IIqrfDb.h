...
namespace iqrf {
  ...
  public:
     ...
     */
    virtual std::vector<Device> getDevices(const std::vector<uint8_t>& requestedDevices = {}) = 0;
     ...
     * @return Product
     */
    virtual std::optional<Product> getProduct(const uint32_t productId) = 0;
     ...
     */
    virtual std::unordered_map<uint32_t, Product> getProductsMap(const std::set<uint32_t>& ids = {}) = 0;
