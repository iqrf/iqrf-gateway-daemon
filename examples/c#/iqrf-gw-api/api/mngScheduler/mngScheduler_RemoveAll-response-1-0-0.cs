...
namespace mngScheduler_RemoveAll_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class MngScheduler_RemoveAll_Response 
    {
        /// <summary>Scheduler management - Remove All response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public MngScheduler_RemoveAll_ResponseMType MType { get; set; }
        ...
        public static MngScheduler_RemoveAll_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<MngScheduler_RemoveAll_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum MngScheduler_RemoveAll_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "mngScheduler_RemoveAll")]
    
        MngScheduler_RemoveAll = 0,
