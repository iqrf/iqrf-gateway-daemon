...
namespace mngScheduler_RemoveAll_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class MngScheduler_RemoveAll_Request 
    {
        ...
        public MngScheduler_RemoveAll_RequestMType MType { get; set; }
        ...
        public static MngScheduler_RemoveAll_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<MngScheduler_RemoveAll_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum MngScheduler_RemoveAll_RequestMType
    {
