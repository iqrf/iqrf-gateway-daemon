...
namespace iqrfEmbedEeeprom_Read_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedEeeprom_Read_Response 
    {
        /// <summary>Embedded peripheral Memory - Read response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedEeeprom_Read_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedEeeprom_Read_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedEeeprom_Read_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedEeeprom_Read_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedEeeprom_Read")]
    
        IqrfEmbedEeeprom_Read = 0,
