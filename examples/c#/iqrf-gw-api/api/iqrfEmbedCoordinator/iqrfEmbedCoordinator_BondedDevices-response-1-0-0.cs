...
namespace iqrfEmbedCoordinator_BondedDevices_Response
{
    ...
    public partial class IqrfEmbedCoordinator_BondedDevices_Response 
    {
        ...
        public IqrfEmbedCoordinator_BondedDevices_ResponseMType MType { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedCoordinator_BondedDevices_ResponseMType
    {
    ...
    {
        /// <summary>Values corresponding to the addresses of the bonded devices</summary>
        [Newtonsoft.Json.JsonProperty("bondedDevices", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<int> BondedDevices { get; set; }
