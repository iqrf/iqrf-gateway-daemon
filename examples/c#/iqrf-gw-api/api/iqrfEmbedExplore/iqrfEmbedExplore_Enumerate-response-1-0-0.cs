...
namespace iqrfEmbedExplore_Enumerate_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedExplore_Enumerate_Response 
    {
        /// <summary>Embedded peripheral Explore - Enumeration response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedExplore_Enumerate_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedExplore_Enumerate_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedExplore_Enumerate_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedExplore_Enumerate_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedExplore_Enumerate")]
    
        IqrfEmbedExplore_Enumerate = 0,
    ...
    public partial class Result 
    {
        ...
        [Newtonsoft.Json.JsonProperty("hwpIdVer", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
