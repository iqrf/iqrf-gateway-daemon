...
namespace iqrfEmbedEeprom_Write_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedEeprom_Write_Request 
    {
        ...
        public IqrfEmbedEeprom_Write_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedEeprom_Write_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedEeprom_Write_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedEeprom_Write_RequestMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedEeprom_Write")]
    
        IqrfEmbedEeprom_Write = 0,
