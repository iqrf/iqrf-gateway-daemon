...
namespace iqrfEmbedRam_Write_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedRam_Write_Request 
    {
        ...
        public IqrfEmbedRam_Write_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedRam_Write_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedRam_Write_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedRam_Write_RequestMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedRam_Write")]
    
        IqrfEmbedRam_Write = 0,
