...
namespace iqrfEmbedFrc_ExtraResult_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedFrc_ExtraResult_Response 
    {
        /// <summary>Embedded peripheral FRC - Extra Result response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedFrc_ExtraResult_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedFrc_ExtraResult_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedFrc_ExtraResult_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedFrc_ExtraResult_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedFrc_ExtraResult")]
    
        IqrfEmbedFrc_ExtraResult = 0,
