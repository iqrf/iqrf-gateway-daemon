...
namespace iqrfEmbedOs_SelectiveBatch_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedOs_SelectiveBatch_Request 
    {
        /// <summary>Embedded peripheral OS - Selective Batch request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedOs_SelectiveBatch_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedOs_SelectiveBatch_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedOs_SelectiveBatch_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedOs_SelectiveBatch_RequestMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedOs_SelectiveBatch")]
    
        IqrfEmbedOs_SelectiveBatch = 0,
    ...
    {
        /// <summary>Array if integer values corresponding to the selected nodes.</summary>
