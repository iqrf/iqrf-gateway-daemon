...
namespace MyNamespace
{
    ...
    {
        private System.Collections.ObjectModel.ObservableCollection<int> _discoveryData = new System.Collections.ObjectModel.ObservableCollection<int>();
    
        /// <summary>Array of bytes with discovery data.</summary>
        [Newtonsoft.Json.JsonProperty("discoveryData", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<int> DiscoveryData
        {
            get { return _discoveryData; }
            set 
            {
                if (_discoveryData != value)
                {
