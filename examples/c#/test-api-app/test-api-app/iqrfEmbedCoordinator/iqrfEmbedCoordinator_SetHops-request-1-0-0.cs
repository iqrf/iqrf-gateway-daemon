...
namespace iqrfEmbedCoordinator_SetHops_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_SetHops_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_SetHops_Request ( string msgId, int NAdr, int HwpId, int requestHops, int responseHops, int timeout, bool verbose )
    {
      this.Data.MsgId = msgId;
      this.Data.Req.NAdr = NAdr;
      this.Data.Req.HwpId = HwpId;
      this.Data.Req.Param.RequestHops = requestHops;
      this.Data.Req.Param.ResponseHops = responseHops;
    ...
    /// <summary>Embedded peripheral Coordinator - Set Hops request.</summary>
    ...
    public static IqrfEmbedCoordinator_SetHops_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_SetHops_Request>( data );
    }
  ...
  public enum MType
  {
    [System.Runtime.Serialization.EnumMember( Value = "iqrfEmbedCoordinator_SetHops" )]
    IqrfEmbedCoordinator_SetHops = 0,
  ...
  {
    private int _requestHops = 255;
    private int _responseHops = 255;

    /// <summary>Allows the specifying fixed number of hops used to send the DPA request or to specify an optimization algorithm to compute a integer of hops.</summary>
    [Newtonsoft.Json.JsonProperty( "requestHops", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore )]
    public int RequestHops
    {
      get { return _requestHops; }
      set
      {
        if ( _requestHops != value )
        {
          _requestHops = value;
          RaisePropertyChanged();
        }
    ...
    /// <summary>Allows the specifying fixed number of hops used to send the DPA response or to specify an optimization algorithm to compute a integer of hops.</summary>
    [Newtonsoft.Json.JsonProperty( "responseHops", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore )]
    public int ResponseHops
    {
      get { return _responseHops; }
      set
      {
        if ( _responseHops != value )
        {
          _responseHops = value;
          RaisePropertyChanged();
        }
