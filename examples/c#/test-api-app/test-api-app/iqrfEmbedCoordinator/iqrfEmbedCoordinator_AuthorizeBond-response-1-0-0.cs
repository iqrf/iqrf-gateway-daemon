...
namespace iqrfEmbedCoordinator_AuthorizeBond_Response
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_AuthorizeBond_Response : System.ComponentModel.INotifyPropertyChanged
  {
    private MType _mType;
    private Data _data = new Data();

    /// <summary>Embedded peripheral Coordinator - Authorize Bond response.</summary>
    ...
    public static IqrfEmbedCoordinator_AuthorizeBond_Response FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_AuthorizeBond_Response>( data );
    }
  ...
  public enum MType
  {
    [System.Runtime.Serialization.EnumMember( Value = "iqrfEmbedCoordinator_AuthorizeBond" )]
    IqrfEmbedCoordinator_AuthorizeBond = 0,
  ...
  {
    private int _bondAddr;
    private int _devNr;

    /// <summary>Address of the node newly bonded to the network.</summary>
    [Newtonsoft.Json.JsonProperty( "bondAddr", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore )]
    public int BondAddr
    {
      get { return _bondAddr; }
      set
      {
        if ( _bondAddr != value )
        {
    ...
    /// <summary>Number of bonded network nodes.</summary>
    [Newtonsoft.Json.JsonProperty( "devNr", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore )]
    public int DevNr
    {
      get { return _devNr; }
      set
