...
namespace iqrfEmbedCoordinator_DiscoveryData_Response
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_DiscoveryData_Response : System.ComponentModel.INotifyPropertyChanged
  {
    private MType _mType;
    private Data _data = new Data();

    /// <summary>Embedded peripheral Coordinator - Discovery Data response.</summary>
    ...
    public static IqrfEmbedCoordinator_DiscoveryData_Response FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_DiscoveryData_Response>( data );
    }
  ...
  public enum MType
  {
    [System.Runtime.Serialization.EnumMember( Value = "iqrfEmbedCoordinator_DiscoveryData" )]
    IqrfEmbedCoordinator_DiscoveryData = 0,
  ...
  {
    private System.Collections.ObjectModel.ObservableCollection<int> _discData = new System.Collections.ObjectModel.ObservableCollection<int>();

    /// <summary>Array of bytes with discovery data.</summary>
    [Newtonsoft.Json.JsonProperty( "discData", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore )]
    public System.Collections.ObjectModel.ObservableCollection<int> DiscData
    {
      get { return _discData; }
      set
      {
        if ( _discData != value )
        {
