...
namespace iqrfEmbedCoordinator_AuthorizeBond_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_AuthorizeBond_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_AuthorizeBond_Request ( string msgId, int NAdr, int HwpId, int reqAddr, int mid, int timeout, bool verbose )
    {
    ...
    /// <summary>Embedded peripheral Coordinator - Authorize Bond request.</summary>
    ...
    public static IqrfEmbedCoordinator_AuthorizeBond_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_AuthorizeBond_Request>( data );
    }
  ...
  public partial class Param : System.ComponentModel.INotifyPropertyChanged
  {
    ...
    /// <summary>See Bond node request. If 0xFF is specified then the pre-bonded node is unbonded and then reset.</summary>
    ...
    /// <summary>Module ID of the node to be authorized.</summary>
