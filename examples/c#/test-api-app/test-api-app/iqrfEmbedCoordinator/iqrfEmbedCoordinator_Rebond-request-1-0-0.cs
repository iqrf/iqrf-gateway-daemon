...
namespace iqrfEmbedCoordinator_Rebond_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_Rebond_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_Rebond_Request ( string msgId, int NAdr, int HwpId, int bondedAddr, int timeout, bool verbose )
    {
    ...
    /// <summary>Embedded peripheral Coordinator - Rebond request.</summary>
    ...
    public static IqrfEmbedCoordinator_Rebond_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_Rebond_Request>( data );
    }
  ...
  public enum MType
  {
    [System.Runtime.Serialization.EnumMember( Value = "iqrfEmbedCoordinator_Rebond" )]
    IqrfEmbedCoordinator_Rebond = 0,
  ...
  public partial class Param : System.ComponentModel.INotifyPropertyChanged
  {
    ...
    /// <summary>Address of the node to be re-bonded.</summary>
