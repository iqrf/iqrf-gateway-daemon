...
namespace iqrfEmbedCoordinator_ClearAllBonds_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_ClearAllBonds_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_ClearAllBonds_Request ( string msgId, int NAdr, int HwpId, int timeout, bool verbose )
    {
    ...
    /// <summary>Embedded peripheral Coordinator - Clear All Bonds request.</summary>
    ...
    public static IqrfEmbedCoordinator_ClearAllBonds_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_ClearAllBonds_Request>( data );
    }
  ...
  public enum MType
  {
    [System.Runtime.Serialization.EnumMember( Value = "iqrfEmbedCoordinator_ClearAllBonds" )]
    IqrfEmbedCoordinator_ClearAllBonds = 0,
