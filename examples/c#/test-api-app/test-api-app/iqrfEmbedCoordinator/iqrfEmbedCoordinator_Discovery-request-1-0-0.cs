...
#pragma warning disable // Disable all warnings
  ...
  public partial class IqrfEmbedCoordinator_Discovery_Request : System.ComponentModel.INotifyPropertyChanged
  {
    private MType _mType;
    private Data _data = new Data();

    public IqrfEmbedCoordinator_Discovery_Request ( string msgId, int NAdr, int HwpId, int maxAddr, int TxPower, int timeout, bool verbose )
    {
      this.Data.MsgId = msgId;
      this.Data.Req.NAdr = NAdr;
      this.Data.Req.HwpId = HwpId;
      this.Data.Req.Param.MaxAddr = maxAddr;
      this.Data.Req.Param.TxPower = TxPower;
