...
#pragma warning disable // Disable all warnings
  ...
  public partial class IqrfEmbedCoordinator_SetDpaParams_Response : System.ComponentModel.INotifyPropertyChanged
  {
  ...
  {
    private int _prevDpaParam;

    /// <summary>Previously set DPA parameter.</summary>
    [Newtonsoft.Json.JsonProperty( "prevDpaParam", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore )]
    public int PrevDpaParam
    {
      get { return _prevDpaParam; }
      set
      {
        if ( _prevDpaParam != value )
        {
          _prevDpaParam = value;
          RaisePropertyChanged();
        }
