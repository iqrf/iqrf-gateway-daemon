  ...
  class Program
  {
    ...
    static void Main ()
    {
      try
      {
        ...
        IqmeshNetwork_OtaUpload_Request request = new IqmeshNetwork_OtaUpload_Request( "test", new iqmeshNetwork_OtaUpload_Request.Req( new System.Collections.ObjectModel.ObservableCollection<int> { 0 }, "CustomDpaHandler-LED-Green-On-7xD-V302-171116.hex", 0, "WithoutCodeLoading" ), 1, true );
