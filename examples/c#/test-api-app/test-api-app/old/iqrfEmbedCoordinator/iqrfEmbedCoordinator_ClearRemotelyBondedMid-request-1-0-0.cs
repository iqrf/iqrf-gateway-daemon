...
namespace iqrfEmbedCoordinator_ClearRemotelyBondedMid_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_ClearRemotelyBondedMid_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_ClearRemotelyBondedMid_Request ( string msgId, int NAdr, int HwpId, int timeout, bool verbose )
    {
    ...
    /// <summary>Embedded peripheral Coordinator - Clear Remotely Bonded Module ID request.</summary>
    ...
    public static IqrfEmbedCoordinator_ClearRemotelyBondedMid_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_ClearRemotelyBondedMid_Request>( data );
    }
  ...
  public enum MType
  {
    [System.Runtime.Serialization.EnumMember( Value = "iqrfEmbedCoordinator_ClearRemotelyBondedMid" )]
    IqrfEmbedCoordinator_ClearRemotelyBondedMid = 0,
