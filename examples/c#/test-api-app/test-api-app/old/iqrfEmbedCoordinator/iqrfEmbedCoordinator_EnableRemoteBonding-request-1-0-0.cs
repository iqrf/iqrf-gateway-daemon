...
namespace iqrfEmbedCoordinator_EnableRemoteBonding_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_EnableRemoteBonding_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_EnableRemoteBonding_Request ( string msgId, int NAdr, int HwpId, int bondingMask, bool control, System.Collections.ObjectModel.ObservableCollection<int> userData, int timeout, bool verbose )
    {
      this.Data.MsgId = msgId;
      this.Data.Req.NAdr = NAdr;
      this.Data.Req.HwpId = HwpId;
      this.Data.Req.Param.BondingMask = bondingMask;
      this.Data.Req.Param.Control = control;
      this.Data.Req.Param.UserData = userData;
    ...
    /// <summary>Embedded peripheral Coordinator - Enable Remote Bonding request.</summary>
    ...
    public static IqrfEmbedCoordinator_EnableRemoteBonding_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_EnableRemoteBonding_Request>( data );
    }
  ...
  public enum MType
  {
    [System.Runtime.Serialization.EnumMember( Value = "iqrfEmbedCoordinator_EnableRemoteBonding" )]
    IqrfEmbedCoordinator_EnableRemoteBonding = 0,
  ...
  public partial class Param : System.ComponentModel.INotifyPropertyChanged
  {
    ...
    /// <summary>Enables remote bonding mode. If enabled then previously bonded nodes are forgotten.</summary>
    ...
    /// <summary>Optional data that can be used at Reset Custom DPA Handler event.</summary>
