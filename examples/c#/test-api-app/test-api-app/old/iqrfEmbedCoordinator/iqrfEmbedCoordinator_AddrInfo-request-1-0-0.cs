...
namespace iqrfEmbedCoordinator_AddrInfo_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_AddrInfo_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_AddrInfo_Request ( string msgId, int NAdr, int HwpId, int timeout, bool verbose )
    {
    ...
    /// <summary>Embedded peripheral Coordinator - Addressing Information request.</summary>
    ...
    public static IqrfEmbedCoordinator_AddrInfo_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_AddrInfo_Request>( data );
    }
