...
namespace iqrfEmbedCoordinator_BondedDevices_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_BondedDevices_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_BondedDevices_Request ( string msgId, int NAdr, int HwpId, int timeout, bool verbose )
    {
    ...
    /// <summary>Embedded peripheral Coordinator - Get Bonded Devices request.</summary>
    ...
    public static IqrfEmbedCoordinator_BondedDevices_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_BondedDevices_Request>( data );
    }
