...
namespace iqrfEmbedCoordinator_DiscoveredDevices_Response
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_DiscoveredDevices_Response : System.ComponentModel.INotifyPropertyChanged
  {
    private MType _mType;
    private Data _data = new Data();

    /// <summary>Embedded peripheral Coordinator - Get Bonded Nodes response.</summary>
    ...
    public static IqrfEmbedCoordinator_DiscoveredDevices_Response FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_DiscoveredDevices_Response>( data );
    }
  ...
  {
    private System.Collections.ObjectModel.ObservableCollection<int> _discoveredDevices = new System.Collections.ObjectModel.ObservableCollection<int>();
    ...
    [Newtonsoft.Json.JsonProperty( "discoveredDevices", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore )]
    public System.Collections.ObjectModel.ObservableCollection<int> DiscoveredDevices
    {
      get { return _discoveredDevices; }
      set
      {
        if ( _discoveredDevices != value )
        {
