...
namespace iqrfEmbedCoordinator_Restore_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_Restore_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_Restore_Request ( string msgId, int NAdr, int HwpId, System.Collections.ObjectModel.ObservableCollection<int> netData, int timeout, bool verbose )
    {
      this.Data.MsgId = msgId;
      this.Data.Req.NAdr = NAdr;
      this.Data.Req.HwpId = HwpId;
      this.Data.Req.Param.NetData = netData;
    ...
    /// <summary>Embedded peripheral Coordinator - Restore request.</summary>
    ...
    public static IqrfEmbedCoordinator_Restore_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_Restore_Request>( data );
    }
  ...
  public enum MType
  {
    [System.Runtime.Serialization.EnumMember( Value = "iqrfEmbedCoordinator_Restore" )]
    IqrfEmbedCoordinator_Restore = 0,
  ...
  {
    private System.Collections.ObjectModel.ObservableCollection<int> _netData = new System.Collections.ObjectModel.ObservableCollection<int>();

    /// <summary>One block of the coordinator network info data previously obtained by a backup command.</summary>
    [Newtonsoft.Json.JsonProperty( "netData", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore )]
    public System.Collections.ObjectModel.ObservableCollection<int> NetData
    {
      get { return _netData; }
      set
      {
