...
namespace iqrfEmbedCoordinator_RemoveBond_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_RemoveBond_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_RemoveBond_Request ( string msgId, int NAdr, int HwpId, int bondedAddr, int timeout, bool verbose )
    {
      this.Data.MsgId = msgId;
      this.Data.Req.NAdr = NAdr;
      this.Data.Req.HwpId = HwpId;
      this.Data.Req.Param.BondedAddr = bondedAddr;
    ...
    /// <summary>Embedded peripheral Coordinator - Remove Bond request.</summary>
    ...
    public static IqrfEmbedCoordinator_RemoveBond_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_RemoveBond_Request>( data );
    }
  ...
  public enum MType
  {
    [System.Runtime.Serialization.EnumMember( Value = "iqrfEmbedCoordinator_RemoveBond" )]
    IqrfEmbedCoordinator_RemoveBond = 0,
  ...
  {
    private int _bondedAddr;

    /// <summary>Address of the node to be removed.</summary>
    [Newtonsoft.Json.JsonProperty( "bondedAddr", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore )]
    public int BondedAddr
    {
      get { return _bondedAddr; }
      set
      {
        if ( _bondedAddr != value )
        {
          _bondedAddr = value;
          RaisePropertyChanged();
        }
