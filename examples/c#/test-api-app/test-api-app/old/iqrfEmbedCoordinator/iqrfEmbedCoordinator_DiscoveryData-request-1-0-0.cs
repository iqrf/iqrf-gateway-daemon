...
namespace iqrfEmbedCoordinator_DiscoveryData_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_DiscoveryData_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_DiscoveryData_Request ( string msgId, int NAdr, int HwpId, int address, int timeout, bool verbose )
    {
      this.Data.MsgId = msgId;
      this.Data.Req.NAdr = NAdr;
      this.Data.Req.HwpId = HwpId;
      this.Data.Req.Param.Address = address;
    ...
    /// <summary>Embedded peripheral Coordinator - Discovery Data request.</summary>
    ...
    public static IqrfEmbedCoordinator_DiscoveryData_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_DiscoveryData_Request>( data );
    }
  ...
  public partial class Param : System.ComponentModel.INotifyPropertyChanged
  {
    ...
    /// <summary>Address of the discovery data to read.</summary>
