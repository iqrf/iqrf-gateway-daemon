...
namespace iqrfEmbedCoordinator_Backup_Request
{
#pragma warning disable // Disable all warnings

  [System.CodeDom.Compiler.GeneratedCode( "NJsonSchema", "9.10.53.0 (Newtonsoft.Json v11.0.0.0)" )]
  public partial class IqrfEmbedCoordinator_Backup_Request : System.ComponentModel.INotifyPropertyChanged
  {
    public IqrfEmbedCoordinator_Backup_Request ( string msgId, int NAdr, int HwpId, int index, int timeout, bool verbose )
    {
      this.Data.MsgId = msgId;
      this.Data.Req.NAdr = NAdr;
      this.Data.Req.HwpId = HwpId;      
      this.Data.Req.Param.Index = index;
    ...
    /// <summary>Embedded peripheral Coordinator - Backup request.</summary>
    ...
    public static IqrfEmbedCoordinator_Backup_Request FromJson ( string data )
    {
      return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_Backup_Request>( data );
    }
  ...
  public partial class Param : System.ComponentModel.INotifyPropertyChanged
  {
    ...
    /// <summary>Index of the block of data.</summary>
