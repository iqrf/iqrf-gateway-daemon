...
#pragma warning disable // Disable all warnings
  ...
  {
    public Req () { }
    public Req ( int deviceAddr, string smartConnectCode, int bondingRetries, System.Collections.ObjectModel.ObservableCollection<int> userData )
    {
      this.DeviceAddr = deviceAddr;
      this.SmartConnectCode = smartConnectCode;
      this.BondingTestRetries = bondingRetries;
