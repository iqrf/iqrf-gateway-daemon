...
namespace iqrfEmbedThermometer_Read_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfEmbedThermometer_Read_Response 
    {
        /// <summary>Embedded peripheral Thermometer - Read response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedThermometer_Read_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedThermometer_Read_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedThermometer_Read_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedThermometer_Read_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedThermometer_Read")]
    
        IqrfEmbedThermometer_Read = 0,
    ...
    {
        /// <summary>Temperature value in *C.</summary>
