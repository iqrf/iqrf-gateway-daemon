...
namespace iqrfBinaryoutput_Enumerate_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfBinaryoutput_Enumerate_Response 
    {
        /// <summary>Standard peripheral Binary Output - Enumeration response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfBinaryoutput_Enumerate_ResponseMType MType { get; set; }
        ...
        public static IqrfBinaryoutput_Enumerate_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfBinaryoutput_Enumerate_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfBinaryoutput_Enumerate_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfBinaryoutput_Enumerate")]
    
        IqrfBinaryoutput_Enumerate = 0,
    ...
    {
        /// <summary>Number of implemented binary outputs.</summary>
