...
namespace iqrfEmbedNode_ReadRemotelyBondedMid_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedNode_ReadRemotelyBondedMid_Response 
    {
        ...
        public IqrfEmbedNode_ReadRemotelyBondedMid_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedNode_ReadRemotelyBondedMid_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedNode_ReadRemotelyBondedMid_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedNode_ReadRemotelyBondedMid_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedNode_ReadRemotelyBondedMid")]
    
        IqrfEmbedNode_ReadRemotelyBondedMid = 0,
    ...
    public partial class Result 
    {
        ...
        [Newtonsoft.Json.JsonProperty("prebondedNodes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<Anonymous2> PrebondedNodes { get; set; }
    ...
    public partial class Anonymous2 
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.ObjectModel.ObservableCollection<int> UserData { get; set; } = new System.Collections.ObjectModel.ObservableCollection<int>();
