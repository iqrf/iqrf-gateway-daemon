...
namespace iqrfEmbedNode_Read_Request
{
    ...
    public partial class IqrfEmbedNode_Read_Request 
    {
        ...
        public static IqrfEmbedNode_Read_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedNode_Read_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedNode_Read_RequestMType
    {
