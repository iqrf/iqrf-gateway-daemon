...
namespace iqrfEmbedIo_Get_Request
{
    ...
    public partial class IqrfEmbedIo_Get_Request 
    {
        ...
        public static IqrfEmbedIo_Get_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedIo_Get_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedIo_Get_RequestMType
    {
