...
namespace iqrfEmbedRam_Read_Response
{
    ...
    public partial class IqrfEmbedRam_Read_Response 
    {
        ...
        public IqrfEmbedRam_Read_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedRam_Read_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedRam_Read_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedRam_Read_ResponseMType
    {
