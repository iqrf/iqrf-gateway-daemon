...
namespace iqrfEmbedRam_Write_Response
{
    ...
    public partial class IqrfEmbedRam_Write_Response 
    {
        ...
        public IqrfEmbedRam_Write_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedRam_Write_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedRam_Write_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedRam_Write_ResponseMType
    {
