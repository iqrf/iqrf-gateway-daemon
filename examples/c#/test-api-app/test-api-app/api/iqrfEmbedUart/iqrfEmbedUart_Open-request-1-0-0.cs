...
namespace iqrfEmbedUart_Open_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedUart_Open_Request 
    {
        /// <summary>Embedded peripheral UART - Open request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedUart_Open_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedUart_Open_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedUart_Open_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedUart_Open_RequestMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedUart_Open")]
    
        IqrfEmbedUart_Open = 0,
    ...
    {
        /// <summary>UART is opened with this baudrate.</summary>
