...
namespace iqrfEmbedUart_Close_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfEmbedUart_Close_Response 
    {
        /// <summary>Embedded peripheral UART - Close request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedUart_Close_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedUart_Close_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedUart_Close_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedUart_Close_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedUart_Close")]
    
        IqrfEmbedUart_Close = 0,
