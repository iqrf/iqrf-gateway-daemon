...
namespace iqrfEmbedUart_ClearWriteRead_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedUart_ClearWriteRead_Response 
    {
        /// <summary>Embedded peripheral UART - Clear Write Read response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedUart_ClearWriteRead_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedUart_ClearWriteRead_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedUart_ClearWriteRead_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedUart_ClearWriteRead_ResponseMType
    {
    ...
    public partial class Result 
    {
        ...
        public System.Collections.ObjectModel.ObservableCollection<int> ReadData { get; set; }
