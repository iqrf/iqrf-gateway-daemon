...
namespace iqrfEmbedUart_ClearWriteRead_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedUart_ClearWriteRead_Request 
    {
        /// <summary>Embedded peripheral UART - Clear Write Read request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedUart_ClearWriteRead_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedUart_ClearWriteRead_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedUart_ClearWriteRead_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedUart_ClearWriteRead_RequestMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedUart_ClearWriteRead")]
    
        IqrfEmbedUart_ClearWriteRead = 0,
    ...
    {
        /// <summary>Specifies timeout in 10 ms unit to wait for data to be read after data is (optionally) written.</summary>
        ...
        /// <summary>Optional data to be written.</summary>
        [Newtonsoft.Json.JsonProperty("writtenData", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<int> WrittenData { get; set; }
