...
namespace iqrfEmbedUart_Close_Request
{
    ...
    public partial class IqrfEmbedUart_Close_Request 
    {
        ...
        public IqrfEmbedUart_Close_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedUart_Close_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedUart_Close_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedUart_Close_RequestMType
    {
