...
namespace iqrfEmbedUart_WriteRead_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfEmbedUart_WriteRead_Request 
    {
        /// <summary>Embedded peripheral UART - Write Read request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedUart_WriteRead_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedUart_WriteRead_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedUart_WriteRead_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedUart_WriteRead_RequestMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedUart_WriteRead")]
    
        IqrfEmbedUart_WriteRead = 0,
