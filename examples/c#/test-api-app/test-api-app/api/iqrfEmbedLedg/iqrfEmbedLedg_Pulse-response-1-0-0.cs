...
namespace iqrfEmbedLedg_Pulse_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedLedg_Pulse_Response 
    {
        /// <summary>Embedded peripheral Ledg - Pulse response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedLedg_Pulse_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedLedg_Pulse_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedLedg_Pulse_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedLedg_Pulse_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedLedg_Pulse")]
    
        IqrfEmbedLedg_Pulse = 0,
