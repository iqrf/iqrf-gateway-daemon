...
namespace iqrfEmbedLedg_Get_Response
{
    ...
    public partial class IqrfEmbedLedg_Get_Response 
    {
        ...
        public static IqrfEmbedLedg_Get_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedLedg_Get_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedLedg_Get_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedLedg_Get")]
