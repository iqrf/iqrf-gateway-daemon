...
namespace iqrfEmbedEeprom_Read_Request
{
    ...
    public partial class IqrfEmbedEeprom_Read_Request 
    {
        ...
        public IqrfEmbedEeprom_Read_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedEeprom_Read_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedEeprom_Read_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedEeprom_Read_RequestMType
    {
