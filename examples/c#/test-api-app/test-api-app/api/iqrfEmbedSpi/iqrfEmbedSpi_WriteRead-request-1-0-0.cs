...
namespace iqrfEmbedSpi_WriteRead_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfEmbedSpi_WriteRead_Request 
    {
        /// <summary>Embedded peripheral SPI - Write Read request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedSpi_WriteRead_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedSpi_WriteRead_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedSpi_WriteRead_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedSpi_WriteRead_RequestMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedSpi_WriteRead")]
    
        IqrfEmbedSpi_WriteRead = 0,
