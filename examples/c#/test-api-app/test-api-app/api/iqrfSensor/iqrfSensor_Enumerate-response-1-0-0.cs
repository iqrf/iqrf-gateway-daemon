...
namespace iqrfSensor_Enumerate_Response
{
    ...
    public partial class IqrfSensor_Enumerate_Response 
    {
        ...
        public IqrfSensor_Enumerate_ResponseMType MType { get; set; }
        ...
        public static IqrfSensor_Enumerate_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfSensor_Enumerate_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfSensor_Enumerate_ResponseMType
    {
    ...
    public partial class Anonymous 
    {
        ...
        [Newtonsoft.Json.JsonProperty("frcs", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<int> Frcs { get; set; }
