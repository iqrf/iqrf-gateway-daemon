...
namespace iqrfEmbedOs_Batch_Response
{
    ...
    public partial class IqrfEmbedOs_Batch_Response 
    {
        ...
        public static IqrfEmbedOs_Batch_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedOs_Batch_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedOs_Batch_ResponseMType
    {
