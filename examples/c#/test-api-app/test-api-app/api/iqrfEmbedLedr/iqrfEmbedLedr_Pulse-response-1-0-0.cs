...
namespace iqrfEmbedLedr_Pulse_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedLedr_Pulse_Response 
    {
        /// <summary>Embedded peripheral Ledr - Pulse response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedLedr_Pulse_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedLedr_Pulse_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedLedr_Pulse_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedLedr_Pulse_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedLedr_Pulse")]
    
        IqrfEmbedLedr_Pulse = 0,
