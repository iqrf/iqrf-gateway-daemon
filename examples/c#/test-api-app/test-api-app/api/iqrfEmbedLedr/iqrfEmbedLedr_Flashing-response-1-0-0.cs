...
namespace iqrfEmbedLedr_Flashing_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedLedr_Flashing_Response 
    {
        /// <summary>Embedded peripheral Ledr - Flashing request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedLedr_Flashing_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedLedr_Flashing_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedLedr_Flashing_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedLedr_Flashing_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedLedr_Flashing")]
    
        IqrfEmbedLedr_Flashing = 0,
