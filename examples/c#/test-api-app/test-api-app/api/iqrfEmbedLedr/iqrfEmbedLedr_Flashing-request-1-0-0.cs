...
namespace iqrfEmbedLedr_Flashing_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedLedr_Flashing_Request 
    {
        ...
        public IqrfEmbedLedr_Flashing_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedLedr_Flashing_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedLedr_Flashing_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedLedr_Flashing_RequestMType
    {
