...
namespace iqrfEmbedLedr_Set_Response
{
    ...
    public partial class IqrfEmbedLedr_Set_Response 
    {
        ...
        public static IqrfEmbedLedr_Set_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedLedr_Set_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedLedr_Set_ResponseMType
    {
