...
namespace iqrfEmbedCoordinator_Discovery_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfEmbedCoordinator_Discovery_Request 
    {
        ...
        public IqrfEmbedCoordinator_Discovery_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedCoordinator_Discovery_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_Discovery_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedCoordinator_Discovery_RequestMType
    {
    ...
    public partial class Param 
    {
        ...
        [Newtonsoft.Json.JsonProperty("maxAddr", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
