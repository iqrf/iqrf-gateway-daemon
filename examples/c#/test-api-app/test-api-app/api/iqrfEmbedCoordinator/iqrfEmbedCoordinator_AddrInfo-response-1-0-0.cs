...
namespace iqrfEmbedCoordinator_AddrInfo_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfEmbedCoordinator_AddrInfo_Response 
    {
        /// <summary>Embedded peripheral Coordinator - Addressing Information response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedCoordinator_AddrInfo_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedCoordinator_AddrInfo_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_AddrInfo_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedCoordinator_AddrInfo_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedCoordinator_AddrInfo")]
    
        IqrfEmbedCoordinator_AddrInfo = 0,
    ...
    public partial class Result 
    {
        ...
        /// <summary>Discovery ID of the network.</summary>
