...
namespace iqrfEmbedCoordinator_SetDpaParams_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfEmbedCoordinator_SetDpaParams_Response 
    {
        /// <summary>Embedded peripheral Coordinator - Set Dpa Params response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedCoordinator_SetDpaParams_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedCoordinator_SetDpaParams_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_SetDpaParams_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedCoordinator_SetDpaParams_ResponseMType
    {
    ...
    {
        /// <summary>Previously set DPA parameter.</summary>
        [Newtonsoft.Json.JsonProperty("prevDpaParam", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? PrevDpaParam { get; set; }
