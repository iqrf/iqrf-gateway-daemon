...
namespace iqrfEmbedCoordinator_RebondNode_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedCoordinator_RebondNode_Request 
    {
        ...
        public IqrfEmbedCoordinator_RebondNode_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedCoordinator_RebondNode_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_RebondNode_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedCoordinator_RebondNode_RequestMType
    {
