...
namespace iqrfEmbedCoordinator_ClearRemotelyBondedMid_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfEmbedCoordinator_ClearRemotelyBondedMid_Response 
    {
        /// <summary>Embedded peripheral Coordinator - Clear Remotely Bonded Module ID response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedCoordinator_ClearRemotelyBondedMid_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedCoordinator_ClearRemotelyBondedMid_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedCoordinator_ClearRemotelyBondedMid_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedCoordinator_ClearRemotelyBondedMid_ResponseMType
    {
