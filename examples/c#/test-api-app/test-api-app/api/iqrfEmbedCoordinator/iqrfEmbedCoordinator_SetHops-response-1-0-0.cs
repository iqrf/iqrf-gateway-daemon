...
namespace iqrfEmbedCoordinator_SetHops_Response
{
    ...
    public partial class IqrfEmbedCoordinator_SetHops_Response 
    {
        ...
        public IqrfEmbedCoordinator_SetHops_ResponseMType MType { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedCoordinator_SetHops_ResponseMType
    {
    ...
    public partial class Result 
    {
        ...
        [Newtonsoft.Json.JsonProperty("requestHops", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? RequestHops { get; set; } = 255;
        ...
        [Newtonsoft.Json.JsonProperty("responseHops", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? ResponseHops { get; set; } = 255;
