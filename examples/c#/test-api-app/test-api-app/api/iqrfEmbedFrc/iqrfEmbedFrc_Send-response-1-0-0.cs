...
namespace iqrfEmbedFrc_Send_Response
{
    ...
    public partial class IqrfEmbedFrc_Send_Response 
    {
        ...
        public static IqrfEmbedFrc_Send_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedFrc_Send_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedFrc_Send_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfEmbedFrc_Send")]
