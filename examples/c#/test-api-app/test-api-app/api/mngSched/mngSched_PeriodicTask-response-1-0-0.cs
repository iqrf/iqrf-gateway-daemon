...
namespace mngSched_PeriodicTask_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class MngSched_PeriodicTask_Response 
    {
        ...
        public MngSched_PeriodicTask_ResponseMType MType { get; set; }
        ...
        public static MngSched_PeriodicTask_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<MngSched_PeriodicTask_Response>(data);
        }
