...
namespace iqrfEmbedExplore_MorePeripheralsInformation_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfEmbedExplore_MorePeripheralsInformation_Request 
    {
        /// <summary>Embedded peripheral Explore - More Peripheral Information request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedExplore_MorePeripheralsInformation_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedExplore_MorePeripheralsInformation_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedExplore_MorePeripheralsInformation_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfEmbedExplore_MorePeripheralsInformation_RequestMType
    {
