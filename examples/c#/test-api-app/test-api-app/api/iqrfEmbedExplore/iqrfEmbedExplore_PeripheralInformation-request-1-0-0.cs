...
namespace iqrfEmbedExplore_PeripheralInformation_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedExplore_PeripheralInformation_Request 
    {
        /// <summary>Embedded peripheral Explore - Peripheral Information request.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedExplore_PeripheralInformation_RequestMType MType { get; set; }
        ...
        public static IqrfEmbedExplore_PeripheralInformation_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedExplore_PeripheralInformation_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum IqrfEmbedExplore_PeripheralInformation_RequestMType
    {
    ...
    {
        /// <summary>Peripheral to get information about.</summary>
