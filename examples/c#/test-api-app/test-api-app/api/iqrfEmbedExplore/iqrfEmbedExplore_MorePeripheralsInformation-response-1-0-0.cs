...
namespace iqrfEmbedExplore_MorePeripheralsInformation_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.56.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class IqrfEmbedExplore_MorePeripheralsInformation_Response 
    {
        /// <summary>Embedded peripheral Explore - More Peripheral Information response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfEmbedExplore_MorePeripheralsInformation_ResponseMType MType { get; set; }
        ...
        public static IqrfEmbedExplore_MorePeripheralsInformation_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfEmbedExplore_MorePeripheralsInformation_Response>(data);
        }
    ...
    public partial class Result 
    {
        ...
        public System.Collections.ObjectModel.ObservableCollection<Anonymous2> Peripherals { get; set; }
