...
namespace iqrfLight_DecrementPower_Request
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfLight_DecrementPower_Request 
    {
        ...
        public IqrfLight_DecrementPower_RequestMType MType { get; set; }
        ...
        public static IqrfLight_DecrementPower_Request FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfLight_DecrementPower_Request>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfLight_DecrementPower_RequestMType
    {
