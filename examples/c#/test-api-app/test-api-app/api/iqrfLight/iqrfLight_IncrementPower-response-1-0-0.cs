...
namespace iqrfLight_IncrementPower_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfLight_IncrementPower_Response 
    {
        /// <summary>Standard peripheral Light - Increment Power response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfLight_IncrementPower_ResponseMType MType { get; set; }
        ...
        public static IqrfLight_IncrementPower_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfLight_IncrementPower_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfLight_IncrementPower_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfLight_IncrementPower")]
    
        IqrfLight_IncrementPower = 0,
