...
namespace iqrfLight_Enumerate_Response
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class IqrfLight_Enumerate_Response 
    {
        /// <summary>Standard peripheral Light - Enumeration response.</summary>
        [Newtonsoft.Json.JsonProperty("mType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IqrfLight_Enumerate_ResponseMType MType { get; set; }
        ...
        public static IqrfLight_Enumerate_Response FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<IqrfLight_Enumerate_Response>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.57.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum IqrfLight_Enumerate_ResponseMType
    {
        [System.Runtime.Serialization.EnumMember(Value = "iqrfLight_Enumerate")]
    
        IqrfLight_Enumerate = 0,
    ...
    {
        /// <summary>Number of implemented binary lights.</summary>
